...
var distsql = flag.Bool("dist-sql", true, "Use DistSQL for query execution (defualt true)")
...
var queries = flag.String("queries", "1,2", "Queries to run. Use a comma separated list of query numbers. Default: (1,2)")
